...
FIX_JSON_SYSTEM_PROMPT = """Ты — эксперт по данным. Исправь текст так, чтобы он стал ВАЛИДНЫМ JSON, строго соответствующим схеме.
...
FIX_JSON_USER_PROMPT = """Исходный текст:
{broken_json_text}
"""
